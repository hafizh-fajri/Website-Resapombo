...
<body class="font-sans text-gray-800 antialiased">
    ...
    <section class="relative bg-cover bg-center h-[800px] pt-40" style="background-image: url('https://images.unsplash.com/photo-1589182373726-e4f658ab50f0?q=80&w=2000&auto=format&fit=crop');">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative -mt-16 z-20">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 text-center transform transition hover:-translate-y-1">
                ...
                <h3 class="text-3xl font-bold text-gray-800">{{ $informasi->luas_wilayah }}<span class="text-lg">ha</span></h3>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 text-center transform transition hover:-translate-y-1">
                ...
                <h3 class="text-3xl font-bold text-gray-800">{{ $informasi->jumlah_rt }}/{{ $informasi->jumlah_rw }}</h3>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <div>
                        <a href="{{ route("profil") }}" class="inline-flex items-center bg-brand-green hover:bg-green-800 text-white font-medium py-3 px-6 rounded-full transition">
    ...
    <section class="py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <div class="flex justify-center items-center gap-2 mb-2">
                    <div class="w-6 h-1 bg-brand-green"></div>
                    <span class="text-brand-green font-bold text-sm uppercase tracking-wider">Informasi Desa Resapombo</span>
                    <div class="w-6 h-1 bg-brand-green"></div>
                </div>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Berita & Artikel</h2>
                <p class="text-gray-500 max-w-6xl mx-auto">Dapatkan informasi terbaru seputar pembangunan, kegiatan warga, dan pengumuman resmi dari Pemerintah Desa Resapombo.</p>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                {{-- Looping data artikel dari controller --}}
                @forelse($artikels as $artikel)
                    <article class="bg-white rounded-3xl border border-[#E9ECEF] p-5 shadow-sm hover:shadow-lg transition-shadow duration-300 flex flex-col">
                        
                        {{-- Gambar Artikel --}}
                        <div class="rounded-2xl overflow-hidden aspect-[4/3] mb-5 relative bg-slate-100">
                            <img src="{{ asset($artikel->gambar) }}" alt="{{ $artikel->judul }}" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500">
                        ...
                        {{-- Judul --}}
                        <h3 class="text-xl font-bold text-slate-950 mb-3 leading-tight line-clamp-2 hover:text-[#286B39] transition-colors cursor-pointer">
                            {{ $artikel->judul }}
                        </h3>
            ...
            <div class="text-center mt-10">
                <a href="{{ route("berita") }}" class="inline-flex items-center bg-brand-green hover:bg-green-800 text-white font-medium py-3 px-8 rounded-full transition">
                    Lihat Semua Berita <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                </a>
            </div>
        </div>
    </section>
