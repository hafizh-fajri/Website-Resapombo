...
<body class="font-sans text-gray-800 antialiased">
    ...
    <section class="relative bg-cover bg-center h-[800px] pt-40"
        style="background-image: url('{{ asset('images/landing/kantor-hero.webp') }}');">
        <div class="absolute inset-0 bg-black bg-opacity-40"></div>

        <div class="relative z-10 text-center px-4 pt-5 max-w-4xl mx-auto mt-10">
            <span
                class="inline-block py-1 px-4 border border-white text-white rounded-full text-xs font-semibold tracking-wider mb-4 uppercase bg-white/20 backdrop-blur-sm">
                Website Desa Resapombo
            </span>
            <h1 class="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">Selamat Datang di<br>Desa Resapombo
            </h1>
            <p class="text-lg md:text-xl text-gray-200 mb-10 max-w-2xl mx-auto">Mewujudkan desa yang mandiri, sejahtera,
                dan berbudaya melalui tata kelola pemerintahan yang transparan dan pengembangan potensi lokal yang
                berkelanjutan.</p>

            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route("potensi") }}"
                    class="bg-brand-green hover:bg-green-800 text-white font-medium py-3 px-8 rounded-full transition flex items-center justify-center gap-2">
                    Jelajahi Potensi <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                    </svg>
                </a>
                <a href="{{ url("https://wa.me/6285852462997") }}"
                    class="bg-white/20 backdrop-blur-sm hover:bg-white/30 border border-white text-white font-medium py-3 px-8 rounded-full transition flex items-center justify-center gap-2">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative -mt-16 z-20">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div class="bg-white rounded-2xl shadow-lg p-6 text-center transform transition hover:-translate-y-1">
                <div
                    class="w-12 h-12 bg-green-100 text-brand-green rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h3 class="text-3xl font-bold text-gray-800">{{ $informasi->jumlah_penduduk }}</h3>
                <p class="text-xs text-gray-500 font-semibold mt-1 tracking-widest uppercase">Penduduk</p>
            </div>
            <div class="bg-white rounded-2xl shadow-lg p-6 text-center transform transition hover:-translate-y-1">
                <div
                    class="w-12 h-12 bg-blue-100 text-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 640 640"><!--!Font Awesome Free v7.3.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.-->
                        <path fill="#0088c7"
                ...
                <h3 class="text-3xl font-bold text-gray-800">{{ $informasi->luas_wilayah }}<span
                        class="text-lg">ha</span></h3>
                <p class="text-xs text-gray-500 font-semibold mt-1 tracking-widest uppercase">Luas Wilayah</p>
            </div>
            <div class="bg-white rounded-2xl shadow-lg p-6 text-center transform transition hover:-translate-y-1">
                <div
                    class="w-12 h-12 bg-yellow-100 text-yellow-500 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 640 640"><!--!Font Awesome Free v7.3.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.-->
                        <path fill="#c3c300"
                ...
                <h3 class="text-3xl font-bold text-gray-800">{{ $informasi->jumlah_dusun }}</h3>
                <p class="text-xs text-gray-500 font-semibold mt-1 tracking-widest uppercase">Dusun</p>
            </div>
            <div class="bg-white rounded-2xl shadow-lg p-6 text-center transform transition hover:-translate-y-1">
                <div
                    class="w-12 h-12 bg-teal-100 text-teal-500 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 640 640"><!--!Font Awesome Free v7.3.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.-->
                        <path fill="#0d631b"
                ...
                <h3 class="text-3xl font-bold text-gray-800">{{ $informasi->jumlah_rt }}/{{ $informasi->jumlah_rw }}
                </h3>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
                ...
                <div class="rounded-3xl overflow-hidden shadow-xl h-full">
                    ...
                    <img src="{{ asset('images/landing/sejarah-hero.webp') }}" alt="Kegiatan Desa"
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Sejarah & Profil Singkat Desa
                        Resapombo</h2>
                    <p class="text-gray-600 mb-4 leading-relaxed">
                        Desa Resapombo merupakan desa agraris yang terletak di wilayah Kecamatan Doko, Kabupaten Blitar.
                        Berada di kawasan dataran tinggi lereng Gunung Kawi dan Gunung Gogoniti, desa ini dianugerahi
                        tanah yang subur serta pemandangan alam yang asri.
                    <p class="text-gray-600 mb-8 leading-relaxed">
                        Pemerintah Desa Resapombo berkomitmen untuk terus meningkatkan kualitas pelayanan publik,
                        mewujudkan transparansi tata kelola pemerintahan, serta mendorong pemberdayaan ekonomi
                        masyarakat berbasis potensi lokal, khususnya sektor peternakan kambing dan perkebunan cengkeh
                        serta kopi.
                    </p>

                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center text-gray-700 font-medium">
                            <svg class="w-5 h-5 text-brand-green mr-3" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div>
                        <a href="{{ route("profil") }}"
                            class="inline-flex items-center bg-brand-green hover:bg-green-800 text-white font-medium py-3 px-6 rounded-full transition">
                            Baca Profil Lengkap <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                            </svg>
    ...
    <section class="pt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-500 max-w-2xl mx-auto">Menjelajahi beragam sektor yang menjadi pilar ekonomi dan
                    kesejahteraan masyarakat desa kami.</p>
            </div>

            <!-- PERUBAHAN UTAMA DI SINI: Menambahkan lg:grid-rows-2 -->
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-2 gap-4 md:gap-6 h-auto lg:h-[500px]">

                <!-- Card Pertanian (Kiri - Memakan 2 Baris Penuh) -->
                <div class="relative group rounded-3xl overflow-hidden lg:row-span-2 h-64 lg:h-full">
                    <img src="{{ asset('images/potensi/pertanian.webp') }}"
                    ...
                    <div class="absolute bottom-0 left-0 p-6 md:p-8">
                        ...
                        <p class="text-gray-300 text-sm md:text-base">Tulang punggung ekonomi warga dengan hasil panen
                            melimpah seperti padi, jagung, dan sayuran organik.</p>
                    </div>
                </div>

                <!-- Card Perkebunan (Kanan Atas - Mengubah lg:h-auto menjadi lg:h-full) -->
                <div class="relative group rounded-3xl overflow-hidden h-64 lg:h-full">
                    <img src="{{ asset('images/potensi/perkebunan.webp') }}"
                        class="w-full h-full object-cover transition duration-700 group-hover:scale-110"
                        alt="Perkebunan">
                ...
                <!-- Wrapper Card Pariwisata & UMKM (Kanan Bawah - Mengubah lg:h-auto menjadi lg:h-full) -->
                <div class="grid grid-cols-2 gap-4 md:gap-6 h-64 lg:h-full">

                    <!-- Card Pariwisata (Menambahkan h-full) -->
                    <div class="relative group rounded-3xl overflow-hidden h-full">
                        <img src="{{ asset('images/potensi/pariwisata.webp') }}"
                            class="w-full h-full object-cover transition duration-700 group-hover:scale-110"
                            alt="Pariwisata">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                    ...
                    <!-- Card UMKM (Menambahkan h-full) -->
                    <div class="relative group rounded-3xl overflow-hidden h-full">
                        <img src="{{ asset('images/potensi/umkm.webp') }}"
                            class="w-full h-full object-cover transition duration-700 group-hover:scale-110" alt="UMKM">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                        <div class="absolute bottom-0 left-0 p-5">
                            <div
                                class="w-8 h-8 bg-white/20 backdrop-blur-md rounded-lg flex items-center justify-center mb-2 text-white">
            ...
            <div class="text-center mt-10">
                <a href="{{ route('potensi') }}"
                    class="inline-flex items-center bg-brand-green hover:bg-green-800 text-white font-medium py-3 px-8 rounded-full transition">
                    Lihat Seluruh Potensi Desa <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                    </svg>
    ...
    <section class="py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <div class="flex justify-center items-center gap-2 mb-2">
                    <div class="w-6 h-1 bg-brand-green"></div>
                    <span class="text-brand-green font-bold text-sm uppercase tracking-wider">Informasi Desa
                        Resapombo</span>
                    <div class="w-6 h-1 bg-brand-green"></div>
                </div>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Berita & Artikel</h2>
                <p class="text-gray-500 max-w-6xl mx-auto">Dapatkan informasi terbaru seputar pembangunan, kegiatan
                    warga, dan pengumuman resmi dari Pemerintah Desa Resapombo.</p>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                {{-- Looping data artikel dari controller --}}
                @forelse($artikels as $artikel)
                    <article
                        class="bg-white rounded-3xl border border-[#E9ECEF] p-5 shadow-sm hover:shadow-lg transition-shadow duration-300 flex flex-col">
                        ...
                        {{-- Judul --}}
                        <h3
                            class="text-xl font-bold text-slate-950 mb-3 leading-tight line-clamp-2 hover:text-[#286B39] transition-colors cursor-pointer">
                            {{ $artikel->judul }}
                        </h3>
                ...
                @empty
                    ...
                    <div class="col-span-1 sm:col-span-2 lg:col-span-3 text-center py-10 text-slate-500">
            ...
            <div class="text-center mt-10">
                <a href="{{ route("berita") }}"
                    class="inline-flex items-center bg-brand-green hover:bg-green-800 text-white font-medium py-3 px-8 rounded-full transition">
                    Lihat Semua Berita <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                    </svg>
                </a>
