...
<body class="bg-gray-50 text-gray-800 antialiased font-sans">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        @php
            ...
            // Asumsi: Kita mencari jabatan yang mengandung kata "kepala desa" 
            // atau tingkat = 1 (sesuaikan 'nama' dengan nama kolom tabel jabatan Anda)
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-10 mb-16 flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
                ...
                {{-- Asumsi Anda memiliki kolom periode di model Perangkat, jika tidak ada hapus atau biarkan statis --}}
        ...
        @foreach($jabatan as $j)
            @php
                // Lewati jika jabatan ini adalah Kepala Desa (karena sudah dirender di atas)
